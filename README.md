...
Self-signup is restricted via the Supabase Auth dashboard to keep this a private tracking tool. To add new users, manually insert their email into the `allowed_users` table or briefly enable provider sign-ups.
